...
GuildTerrContriMoney_Rate = 30;     -- 1金可以兑换的贡献度
GuildTerrContri_EveryDay = 1200;     -- 每天最多可以兑换的贡献度

GuildBankHistoryCount = 500;        -- 帮会仓库保留的历史数目

GuildOpTimeMgrNeed     = 1;     -- 1秒 堂主职位变更
GuildOpTimeSenatorNeed = 1;     -- 12小时 长老职位变更
GuildOpTimeLeaderNeed  = 1;     -- 12小时 帮主职位变更
GuildMaxBundCount = 3