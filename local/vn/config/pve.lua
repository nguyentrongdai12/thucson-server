...
NpcLevel = GetLimitLevel()-10;
BroadcastEndFlag = 0;
if NpcLevel  >= 99 then
	NpcLevel = 80
end
BossSet = {5363,5379,5406,5407}
PVESceneResId = 21
...
function IsPVETime()
    ...
    if (DayOfWeek == 0 or DayOfWeek == 6 or DayOfWeek == 3) and (Hour >= 12 and Hour < 14) then
        return 1;
    end
    if (DayOfWeek == 0 or DayOfWeek == 6 or DayOfWeek == 3) and (Hour >= 15 and Hour < 17) then
        return 1;
    end
    if (DayOfWeek == 0 or DayOfWeek == 6 or DayOfWeek == 3) and (Hour >= 19 and Hour < 21) then
        return 1;
    end
    if (DayOfWeek == 0 or DayOfWeek == 6 or DayOfWeek == 3) and (Hour >= 21 and Hour < 23) then
        return 1;
    end
...
function OnBeginPVE()
    ...
    TransportNpc1 = CreateSceneNpc(1, 2074, 10, -1658, 8)
